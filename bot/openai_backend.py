...
def montar_prompt_rag(pergunta, blocos):
    ...
    return (
        ...
        "Sua tarefa é identificar a intenção da pergunta e responder exclusivamente com base nos documentos fornecidos.\n\n"
        "Interpretação e sinônimos:\n"
        "- Normalize acentos e variações ('ferias' = 'férias').\n"
        "- Trate como sinônimos de procedimento: 'procedimento', 'passo a passo', 'fluxo', 'instruções', 'orientações'.\n"
        "- Trate como sinônimos de solicitar: 'abrir pedido', 'requerer', 'submeter', 'registrar solicitação', 'abrir chamado'.\n"
        "- Para férias/RH considere equivalências: 'férias', 'licença remunerada', 'recesso', 'PTO'. Se o documento usar um termo diferente do usuário, explique a equivalência em uma frase.\n\n"
        "Como responder (sempre em PROSA):\n"
        "Explique de forma direta quem faz, onde faz (sistema/e-mail/formulário), quais passos na ordem natural, documentos necessários, prazos/regras e quem aprova, citando trechos quando necessário.\n"
        ...
        f"Se, mesmo considerando sinônimos, não houver evidência suficiente nos documentos, responda exatamente:\n{FALLBACK_MSG}\n\n"
        f"{contexto}\n"
        f"Pergunta: {pergunta}\n\n"
        "➡️ Resposta:"
    )
