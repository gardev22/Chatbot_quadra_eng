...
/* === Fallback exclusivo do botão ENTRAR ===
   Se o Streamlit mover o st.button para fora de .login-actions,
   estilizamos o PRIMEIRO botão imediatamente após a âncora #login_actions. */
...
/* Centraliza visualmente o bloco onde o botão foi parar */
div[data-testid="stVerticalBlock"]:has(> #login_actions)
