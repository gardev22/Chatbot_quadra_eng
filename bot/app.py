...
def render_login_screen():
    """Tela de login centralizada, título branco, sem 'Press Enter...' e com degradê mais claro."""
    st.markdown("""
    <style>
    /* Fundo: azul mais claro */
    .stApp{
        background: radial-gradient(1200px 720px at 50% 32%,
                    #6ea0ff 0%, #4a7ef0 35%, #274fae 65%, #0f1b34 100%) !important;
    ...
    /* Centraliza conteúdo no meio da tela */
    ...
    .login-logo{ width:64px; height:64px; object-fit:contain; display:block; margin: 0 auto 14px; }
    .login-title{ font-size:1.6rem; font-weight:800; color:#ffffff; margin:4px 0 8px; }
    .login-sub{ font-size:.98rem; color:rgba(255,255,255,.78); margin:0 0 16px; }
    .login-disc{ font-size:.76rem; color:rgba(255,255,255,.65); margin-top:18px; }

    /* Campo e botão centralizados num miolo estreito */
    .login-fields{ width:min(640px, 90vw); margin:0 auto; }
    ...
    # --- Validação simples sem st.form (nada de 'Press Enter...')
    def _submit_login():
    ...
    # Foco + desativa autocomplete chato
    st.markdown("""
    <script>
    (function(){
      const t=setInterval(()=>{
