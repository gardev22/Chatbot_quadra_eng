...
def email_permitido(email: str) -> bool:
    ...
    dominios_permitidos = ("@quadra.com.vc", "@partners.com.vc")
    return email.endswith(dominios_permitidos)
    ...
    with col_mid:
        ...
        def _try_login():
            ...
            if "@" not in email_val:
                ...
                return
            if not email_permitido(email_val):
                st.session_state["login_error"] = "Acesso restrito. Use seu e-mail **@quadra.com.vc** ou **@partners.com.vc**."
                return
            if not pwd_val:
        ...
        st.text_input(
            ...
            placeholder="seu.nome@quadra.com.vc ou @partners.com.vc",
...
def render_register_screen():
    ...
    with col_mid:
        ...
        if criar:
            email_ok = email_permitido(email)
            if not email_ok:
                st.error("Use um e-mail válido **@quadra.com.vc** ou **@partners.com.vc**.")
