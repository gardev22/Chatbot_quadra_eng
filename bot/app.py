...
/* Aqui deixamos os botões neutros/transparente.
   Os estilos reais vêm de .login-actions e .secondary-actions */
...
/* Esses são os que você quer SEMPRE nesse estilo azul/transparente */
...
# Usuário autenticado: histórico global
